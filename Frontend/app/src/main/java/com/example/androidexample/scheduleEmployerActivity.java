...
public class scheduleEmployerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createSchedule = findViewById(R.id.createScheduleButtonEmployer);
        ...
        createSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(scheduleEmployerActivity.this, createScheduleEmployerActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(scheduleEmployerActivity.this, employerActivity.class);
            startActivity(intent);
            return true;
        }
